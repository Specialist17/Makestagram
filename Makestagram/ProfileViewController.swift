...
class ProfileViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        profileHandle = UserService.observeProfile(for: user, completion: { (ref, user, posts) in
            self.profileRef = ref
            self.user = user
            self.posts = posts
    ...
    @IBAction func findFriendsButtonPressed(_ sender: UIBarButtonItem) {
    }
...
extension ProfileViewController: ProfileHeaderViewDelegate {
    func didTapSettingsButton(_ button: UIButton, on headerView: ProfileHeaderView) {
        ...
        let signOutAction = UIAlertAction(title: "SignOut", style: .default) { _ in
            do {
